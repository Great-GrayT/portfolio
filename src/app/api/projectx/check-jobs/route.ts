...
function analyzeJobDescription(description: string): JobAnalysis {
  ...
  const expertiseKeywords: Record<string, RegExp> = {
    ...
    'Investment Banking': /investment\s*bank(?:ing)?/gi,
  ...
  const jobTypes = [
    ...
    { type: 'Private Equity', keywords: ['private equity', 'PE '] },
    { type: 'Hedge Fund', keywords: ['hedge fund'] },
    { type: 'Asset Management', keywords: ['asset management', 'asset manager'] },
    { type: 'Risk Management', keywords: ['risk manager', 'risk management'] },
  ...
  const companyTypes = [
    ...
    { type: 'Hedge Fund', keywords: ['hedge fund', 'bridgewater', 'citadel'] },
    { type: 'Private Equity', keywords: ['private equity', 'kkr', 'blackstone', 'carlyle'] },
    { type: 'Consulting', keywords: ['mckinsey', 'bain', 'bcg', 'consulting'] },
  ];
  ...
  // Extract Keywords
  const stopWords = new Set(['the', 'and', 'for', 'with', 'you', 'will', 'are', 'have', 'this', 'that']);
